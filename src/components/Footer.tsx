  ...
  return (
    <footer className="relative overflow-hidden bg-gradient-to-br from-gray-900 via-slate-900 to-black">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-20 left-10 w-64 h-64 bg-gradient-to-r from-violet-500/10 to-purple-500/10 rounded-full blur-3xl"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
        ...
        <div className="text-center mb-12">
          <div className="flex justify-center items-center mb-4">
            <Crown className="w-8 h-8 text-violet-400 mr-3" />
            <h3 className="text-4xl font-bold bg-gradient-to-r from-violet-400 via-purple-400 to-blue-400 bg-clip-text text-transparent">
              HEMTECH
            </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-300 leading-relaxed">
              Creating digital excellence through innovative web solutions and strategic marketing.
            </p>
            <div className="flex space-x-3">
              {socialLinks.map((social, index) => (
                <a
                  ...
                  className="bg-white/10 backdrop-blur-sm p-3 rounded-lg hover:bg-gradient-to-r hover:from-violet-500 hover:to-purple-500 transition-all duration-300 transform hover:scale-110 border border-white/20 group"
                >
              ...
              {quickLinks.map((link, index) => (
                <li key={index}>
                  <button
                    ...
                    className="text-gray-300 hover:text-violet-400 transition-colors duration-200 font-medium flex items-center group"
                  >
                    <span className="w-1.5 h-1.5 bg-violet-400 rounded-full mr-3 group-hover:scale-150 transition-transform"></span>
                    {link.name}
                  </button>
                </li>
              ))}
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                <Phone className="w-5 h-5 text-violet-400 mr-3 flex-shrink-0" />
              ...
              <div className="flex items-center">
                <Mail className="w-5 h-5 text-violet-400 mr-3 flex-shrink-0" />
                <span className="text-gray-300 text-sm">vidonyihemstone99@gmail.com</span>
              </div>
              <div className="flex items-center">
                <MapPin className="w-5 h-5 text-violet-400 mr-3 flex-shrink-0" />
        ...
        <div className="border-t border-gray-700 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 mb-4 md:mb-0 flex items-center">
              <Crown className="w-4 h-4 text-violet-400 mr-2" />
